  ...
  return (
    <SectionReveal as="section" className="w-full">
      <div className="mx-auto w-full max-w-[var(--grid-max-width)] px-[var(--space-5)] py-[var(--space-8)]">
        <div
          data-reveal-child
          className="flex flex-wrap items-end justify-between gap-[var(--space-4)]"
        >
          <div className="flex flex-col gap-[var(--space-3)]">
            <h2 className="text-[length:var(--text-headline-lg)] leading-[1.15]">{title}</h2>
        ...
        <div
          data-reveal-child
          className="mt-[var(--space-6)] grid grid-flow-dense grid-cols-1 gap-[var(--space-6)] md:grid-cols-2 lg:grid-cols-3"
        >
